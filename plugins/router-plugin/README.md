...
2. Copy the relevant skill folder into the agent surface used by that repository. The current repo-native Codex sync skips this package until its skills add `agents/openai.yaml` markers.
